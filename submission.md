...
**Candidate name:*Sai Krishna Nalabolu*  
**Email:*vasundsai0889@gmail.com*  
**Date submitted:*25-05-2026*  
**Hours spent (approximate):*3hrs*  
  
## Deliverables checklist 
- [&check; ] Part A: Terraform code under /terraform applies cleanly on LocalStack 
- [ &check;] Part A: `terraform validate` and `terraform fmt -check` both pass 
